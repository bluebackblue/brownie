...
namespace NBsys{namespace ND3d11
{
	...
	*/
	...
	public:
		...
		*/
		#if(BSYS_FONT_ENABLE)
		void Render_SetFont(D3d11_FontTextureType::Id a_fonttexture_type,s32 a_drawtypemax,sharedptr<NBsys::NFont::Font>& a_font,s32 a_texture_width,const STLWString& a_name);
		#endif
