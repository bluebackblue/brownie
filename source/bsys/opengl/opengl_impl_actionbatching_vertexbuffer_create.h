...
namespace NBsys{namespace NOpengl
{
	...
	*/
	...
	private:
		...
		/** copy constructor禁止。
		*/
		Opengl_Impl_ActionBatching_VertexBuffer_Create(const Opengl_Impl_ActionBatching_VertexBuffer_Create& a_this) = delete;

		/** コピー禁止。
		*/
		void operator =(const Opengl_Impl_ActionBatching_VertexBuffer_Create& a_this) = delete;
