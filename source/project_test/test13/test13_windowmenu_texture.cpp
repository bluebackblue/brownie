...
/** constructor
*/
Test13_WindowMenu_Texture::Test13_WindowMenu_Texture(s32 a_id,const STLWString& a_string,f32 a_offset_x,f32 a_offset_y,sharedptr<NBsys::ND3d11::D3d11>& a_d3d11)
	:
	NBsys::NWindowMenu::WindowMenu_Window_Base("Test13_WindowMenu_Texture"),
	id(a_id),
	endrequest(false),
	window_texture(),
	d3d11(a_d3d11)
	...
	*/
	...
	//ウィンドウ -> ボディー背景 -> コントロール -> ボタンエリア -> 左ボタン。
	{
		...
		t_lbutton->Initialize(t_inititem);
		{
			...
			t_lbutton->string = L"<<<<<<<<<";
			t_lbutton->action = std::bind(&Test13_WindowMenu_Texture::PushLeftButton,this);
		}
	}
	...
	//ウィンドウ -> ボディー背景 -> コントロール -> ボタンエリア -> 右ボタン。
	{
		...
		t_rbutton->Initialize(t_inititem);
		{
			...
			t_rbutton->string = L">>>>>>>>>";
			t_rbutton->action = std::bind(&Test13_WindowMenu_Texture::PushRightButton,this);
		}
	}
...
/** destructor
*/
Test13_WindowMenu_Texture::~Test13_WindowMenu_Texture()
{
}

/** 削除リクエスト。取得。
*/
bool Test13_WindowMenu_Texture::CallBack_GetDeleteRequest()
{
...
/** 削除リクエスト。設定。
*/
void Test13_WindowMenu_Texture::CallBack_SetDeleteRequest()
{
...
/** 右ボタン。
*/
void Test13_WindowMenu_Texture::PushRightButton()
{
	STLVector<s32>::Type t_list;
	this->d3d11->CreateTextureIdList(t_list);
	if(t_list.size() <= 0){
