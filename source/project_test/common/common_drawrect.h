			...
			case 0:
				{
					...
					//シェーダー。
					sharedptr<NBsys::NFile::File_Object> t_vertex_fx(new NBsys::NFile::File_Object(DeviceIndex::Common,L"drawrect_vertex.fx",-1,sharedptr<NBsys::NFile::File_Allocator>(),1));
					sharedptr<NBsys::NFile::File_Object> t_pixel_fx(new NBsys::NFile::File_Object(DeviceIndex::Common,L"drawrect_pixel.fx",-1,sharedptr<NBsys::NFile::File_Allocator>(),1));
