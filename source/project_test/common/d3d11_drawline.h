			...
			case 0:
				{
					...
					//コンスタントバッファ。
					this->vs_constantbuffer_b0_id = this->d3d11->CreateConstantBuffer(0,sizeof(VS_ConstantBuffer_B0));
			...
			case 2:
				{
					if(this->vertex_index > 0){
						...
						PS_ConstantBuffer_B0 t_ps_constantbuffer_b0;
						{
